    ...
    >
        ...
        <div className="relative z-20 bg-white/50 dark:bg-black/20 backdrop-blur-md border-b border-elixra-copper/10 px-4 py-2 flex items-center justify-between">
            <div className="flex items-center gap-4">
                <Link href="/collaborate" className="flex items-center gap-2 text-sm text-elixra-text-secondary hover:text-elixra-bunsen transition-colors">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-white dark:bg-elixra-charcoal border-t border-elixra-copper/10 z-50 px-4 flex items-center justify-around shadow-lg-up pb-safe">
            <button
                ...
                className={`flex flex-col items-center justify-center space-y-1 w-20 py-1 rounded-xl transition-all ${
                    activeMobileTab === 'shelf' ? 'text-elixra-bunsen bg-elixra-bunsen/10' : 'text-gray-400 hover:text-gray-500'
                }`}
            >
            ...
            <button
                ...
                className={`flex flex-col items-center justify-center space-y-1 w-20 py-1 rounded-xl transition-all ${
                    activeMobileTab === 'bench' ? 'text-elixra-bunsen bg-elixra-bunsen/10' : 'text-gray-400 hover:text-gray-500'
                }`}
            >
            ...
            <button
                ...
                className={`flex flex-col items-center justify-center space-y-1 w-20 py-1 rounded-xl transition-all relative ${
                    activeMobileTab === 'analysis' ? 'text-elixra-bunsen bg-elixra-bunsen/10' : 'text-gray-400 hover:text-gray-500'
                }`}
            >
